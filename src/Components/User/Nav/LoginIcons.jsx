...
export default function LoginIcons(props) {
  ...
  return (
    <>
      {currentUser ? (
        <div className="lg:px-2 lg:ms-0 -me-4 flex items-center ">
          <div className="me-4 hover:bg-black/10 p-3 rounded-md ">
            <Link onClick={() => dispatch(getHref("/cart"))} to="/cart">
          ...
          <div className="hidden lg:flex ">
            <div className="me-4 hover:bg-black/10 p-3 rounded-md ">
              <Link
                onClick={() => dispatch(getHref("/wishlist"))}
                to="/wishlist"
              >
            ...
            <div className="logOutNav relative">
              <div className="me-4 hover:bg-black/10 p-3 rounded-md ">
                <Link
                  onClick={() => dispatch(getHref("/profile"))}
                  to="/profile"
                >
